...
const Nav = class {
    ...
    async componentDidLoad() {
        ...
        this.didLoad = true;
        this.rootChanged();
        this.gesture = (await import('./swipe-back-BKw2CAHc.js')).createSwipeBackGesture(this.el, this.canStart.bind(this), this.onStart.bind(this), this.onMove.bind(this), this.onEnd.bind(this));
